                ...
                <div class="domain-leftinfo">
                    ...
                    <div class="action-btn">
                        <a href="#" class="btn add-btn">
                          Add To Cart
                          <svg class="ms-2" width="27" height="18" viewBox="0 0 27 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="domain-rightinfo">
                   <div class="section-header">
                    ...
                    <div class="domain-information mb-4">
                        ...
                        <p>Don't settle for a inferior domain name when the one you want and need is available! Buy Premium Domain name Today !!!!</p>
